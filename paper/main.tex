...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/01_channel_selection.png}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/02_frozen_prediction.png}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/03_sign_interventions.png}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/05_fixed_energy_example.png}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/04_parameter_boundaries.png}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/06_revision_diagnostics.png}
...
Xiao Tian initiated and directed the study and manuscript revisions and takes responsibility for the work. OpenAI Codex provided assistance with methodology and mathematical analysis, experimental implementation and execution, results analysis and checking, and manuscript preparation. The reported checks do not constitute independent validation.
